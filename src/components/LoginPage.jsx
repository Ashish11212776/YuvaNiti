  ...
  return (
    ...
    <div className="flex flex-col md:flex-row m-6 p-4 w-full md:w-[90%] lg:w-[80%] min-h-screen font-roboto mx-auto gap-6 bg-white">
      ...
      <div className="hidden md:flex flex-col justify-center items-start w-1/2 gap-6 p-8 rounded-lg h-auto ">
        ...
        <button
          className="w-1/2 text-blue-400 border-2 border-blue-400 flex items-center justify-center py-3 rounded-md hover:bg-blue-50 transition-all duration-300 font-medium"
              ...
              <>
                ...
                <div className="flex justify-center mt-5">
                  <button
                    ...
                    className={`text-blue-600 transition duration-300 text-sm hover:underline ${
