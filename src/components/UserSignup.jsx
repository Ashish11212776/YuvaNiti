            ...
            {!isOtpSend ? (
              <>
                ...
                <input
                  ...
                  className="border border-gray-300 p-4 mb-4 text-xl text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-300 bg-gray-50  h-[52px] w-full rounded-md shadow-sm"
                  value={user_number}
                  name="usernumber"
                ...
                <div className="mb-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <input
                    ...
                    className="border border-gray-300 p-4 focus:outline-none text-xl text-gray-700 focus:ring-2 focus:ring-blue-300 bg-gray-50  h-[52px] w-full sm:w-[50%] rounded-md shadow-sm"
                    value={user_captcha}
                    name="captcha"
                    onChange={handleChange}
                  />
